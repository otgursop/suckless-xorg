 ...
 */
static char *font = "JetBrainsMono Nerd Font:pixelsize=17:style=Medium:antialias=true:autohint=true";
// static char *font = "JetBrainsMono Nerd Font:pixelsize=17:style=Medium:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
static const char *colorname[] = {
	...
	"#fbf1c7",  /* 256 -> cursor (foreground) */
	"#282828",  /* 257 -> rev cursor (background) */
	"#282828",  /* 258 -> bg */
	"#fbf1c7",  /* 259 -> fg */
};
