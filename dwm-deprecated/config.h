...
#if SWALLOW_PATCH
static const int swallowfloating         = 4;   /* 1 means swallow floating windows by default */
#endif // SWALLOW_PATCH
...
#endif // NAMETAG_PATCH
{
	[DEFAULT_TAGS]        = { "a", "b", "c", "4", "5", "6", "7", "8", "9" },
...
static const Rule rules[] = {
  ...
  RULE(.class = "Blueman-services", .isfloating = 1)
  RULE(.class = "nwg-look", .isfloating = 1)
  RULE(.class = "qbittorrent", .isfloating = 1)
  RULE(.class = "Kvantum", .isfloating = 1)
  RULE(.class = "polkit-gnome-authentication-agent-1", .isfloating = 1)
...
static const int refreshrate = 150;  /* refresh rate (per second) for client move/resize */
#if PLACEMOUSE_PATCH
